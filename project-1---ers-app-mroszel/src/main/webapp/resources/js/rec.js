function change_myselect(sel) {
	...
	switch (sel) {
		case "all":
			...
			var dest = '/project-1---ers-app-mroszel/recSubmit.json';
			break;
		case "pending":
			var dest = '/project-1---ers-app-mroszel/pendSubmit.json';
			break;
		case "approved":
			var dest = '/project-1---ers-app-mroszel/appSubmit.json';
			break;
		case "denied":
			var dest = '/project-1---ers-app-mroszel/denSubmit.json';
			break;
